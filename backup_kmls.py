...
class POI():
    ...
    def osmhtmlstr(self):
        popupMsg = '\"<b>%s</b><br />%s<br />Coordinates: (%.7f, %.7f)<br /><a href=\\"%s\\">OSM</a>, <a href=\\"%s\\">Google Maps</a>, <a href=\\"%s\\">Bing<\/a>\"<br /><a href=\"mailto:juho.happola@iki.fi\">Report a mistake</a>'%(self.name,self.desc,self.lat,self.lon,self.osmUrl(),self.gmapUrl(),self.bingUrl())
